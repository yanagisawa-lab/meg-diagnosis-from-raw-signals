...
#Classify the (800ms*160ch) data to 3 diseases
...
class MNet_with_Power_3_disease(Chain):
    def __init__(self):
        super(MNet_with_Power_3_disease, self).__init__()
